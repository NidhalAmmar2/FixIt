...
use FixItBundle\Form\Type\OffreType;
use FixItBundle\Form\Type\OffreFilterType;
...
class OffreController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        $qb = $em->getRepository('FixItBundle:Offre')->createQueryBuilder('o');
       $paginator = $this->filter($request,$form, $qb, 'offre');
           /*     return $this->render('FixItBundle:Offre:index.html.twig', array(
       ...
       // $paginator  = $this->get('knp_paginator');
        ...
        return $this->render('FixItBundle:Offre:index.html.twig', array( 'form' => $form->createView(),
            'paginator' => $paginator));
    }
    ...
    public function showAction(Offre $offre)
    {
        ...
        return $this->render('FixItBundle:Offre:show.html.twig', array(
            'offre' => $offre,
    ...
    public function newAction()
    {
        ...
        return $this->render('FixItBundle:Offre:new.html.twig', array(
            'offre' => $offre,
            'form'   => $form->createView(),
        ));
    }
    ...
    public function editAction(Offre $offre)
    {
        ...
        return $this->render('FixItBundle:Offre:edit.html.twig', array(
            'offre' => $offre,
