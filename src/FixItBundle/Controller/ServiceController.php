...
use FixItBundle\Form\Type\ServiceType;
use FixItBundle\Form\Type\ServiceFilterType;
...
class ServiceController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        $qb = $em->getRepository('FixItBundle:Service')->createQueryBuilder('s');
        $paginator = $this->filter($request,$form, $qb, 'service');
                return $this->render('FixItBundle:Service:index.html.twig', array(
    ...
    public function showAction(Service $service)
    {
        ...
        return $this->render('FixItBundle:Service:show.html.twig', array(
            'service' => $service,
    ...
    public function newAction()
    {
        ...
        return $this->render('FixItBundle:Service:new.html.twig', array(
            'service' => $service,
            'form'   => $form->createView(),
        ));
    }
    ...
    public function editAction(Service $service)
    {
        ...
        return $this->render('FixItBundle:Service:edit.html.twig', array(
            'service' => $service,
    ...
    protected function filter(Request $request,FormInterface $form, QueryBuilder $qb, $name)
    {
        ...
        return $this->get('knp_paginator')->paginate($qb, $request->query->get('page', 1), 7);
    }
